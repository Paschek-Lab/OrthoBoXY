...
A more generalized version of this “OrthoBoXY” approach can be applied to any orthorhombic MD box is tested in the paper “An OrthoBoXY-Method for Various Alternative Box Geometries”, which has been published in [PCCP](https://doi.org/10.1039/D3CP04916G). Its preprint is publicly available at [arXiv](http://arxiv.org/abs/2310.01026).

The method is tested for various systems such as liquid water, dimethylether, methanol, triglyme, water/methanol mixtures, water/triglyme mixtures, and imidazolium-based ionic liquids in the paper "Computing Accurate True Self-Diffusion Coefficients and Shear Viscosities Using the OrthoBoXY Approach", published in the [Journal of Physical Chemistry B](https://doi.org/10.1021/acs.jpcb.3c07540). The corresponding preprint is publicly available from [ChemRxiv](https://doi.org/10.26434/chemrxiv-2023-fvf5q).
