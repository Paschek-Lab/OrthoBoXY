...
c-----
     ...
     .                 *(1.0d0+4.0d0*alpha2/k2)
      ...
      print*, '--------------------------------------------------------'
      print*, ''
      print*, ' D_PBC_i = D_0 - k_B*T/(6*Pi*eta) * chi_i/b_i'
      print*, '       i = {x,y,z}'
      print*, ''
      print*, ' Usage: '
      print*, ''
      print*, ' kikugawa_aniso -alpha <alpha> ',
     .        '-bx <bx> -by <by> -bz <bz> -hmax <hmax> -kmax <kmax>'
      print*, ''
      print*, '--------------------------------------------------------'                  
      ...
      print*, 'chi_x/b_x: ',-(nxsum+kxsum-func1-func2)*1.50d0
      print*, 'chi_y/b_y: ',-(nysum+kysum-func1-func2)*1.50d0
      print*, 'chi_z/b_z: ',-(nzsum+kzsum-func1-func2)*1.50d0

      print*, '---'

      print*, 'chi_x: ', -( nxsum+kxsum-func1-func2)*bx*1.50d0
      print*, 'chi_y: ', -( nysum+kysum-func1-func2)*by*1.50d0
      print*, 'chi_z: ', -( nzsum+kzsum-func1-func2)*bz*1.50d0
